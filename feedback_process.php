...
if (isset($_REQUEST['submit'])) {
	...
	$insert="INSERT INTO user_feedback (user_name,user_email,feedback) 
...
$mail->msgHTML("<h1> Online Blogging Application has recieved a feedback from '".$name."' </h1>");
...
if (!$mail->send()) {
    header("location:feedback.php?msg=$mail->ErrorInfo");
} 
else {
