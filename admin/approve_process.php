...
if (isset($_REQUEST['user_id'])) {
	...
	$update="UPDATE `user` SET is_approved = 'Approved', is_active = 'Active' WHERE user_id= '".$user_id."' ";
...
$mail->Subject = 'Approval of account registration';
//Read an HTML message body
//$mail->isHTML();
//$mail->msgHTML("This Is Testing Message Using PhpMailer");
$mail->msgHTML("<h1> Your account request has been approved now you can login  </h1>");
