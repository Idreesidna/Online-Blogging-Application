...
$date = date('Y-m-d H:i:s');
  ...
  $update="UPDATE `user` SET first_name= '".$first_name."', last_name = '".$last_name."',gender='".$gender."',date_of_birth= '".$dob."',address= '".$address."', updated_at='".$date."' WHERE user_id= '".$user_id."' ";
...
if (isset($_FILES['image'])) {
  ...
  if ($img_size > 1000000) {
    ...
    if (in_array($img_ex_lc, $allowed_exs)) {
        ...
        $update_pic="UPDATE `user` SET user_image='".$new_img_name."', updated_at='".$date."' WHERE user_id= '".$user_id."' ";
